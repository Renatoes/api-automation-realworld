...
public class RealworldSteps extends BaseSteps {
  ...
  @Step
  public static void updateUserProfile(DataTable dataTable) throws IOException {
    sendRequestWithBodyJson(PUT,_API_USER_,
            createBody(dataTable));
  }

  @Step
  public static void createPost(DataTable dataTable) throws IOException {
    sendRequestWithBodyJson(POST,_API_ARTICLES_,
            createBody(dataTable));
  }
  @Step
  ...
  public static void modifyPost(DataTable dataTable) throws IOException {
    sendRequestWithBodyJson(PUT,_API_ARTICLES_+ sessionVariableCalled("slug"),
            createBody(dataTable));
  }
  @Step
  public static void addingComment(DataTable dataTable) throws IOException {
    sendRequestWithBodyJson(POST,_API_ARTICLES_+ sessionVariableCalled("slug") + "/comments/",
            createBody(dataTable));
  }

  @Step
  public static void deleteComment() {
    // /api/articles/hiy2h1y3uyh2iuh31a/comments/3
    sendRequest(DELETE,_API_ARTICLES_ + sessionVariableCalled("slug") + "/comments/" + sessionVariableCalled("comment_id"));
  }
